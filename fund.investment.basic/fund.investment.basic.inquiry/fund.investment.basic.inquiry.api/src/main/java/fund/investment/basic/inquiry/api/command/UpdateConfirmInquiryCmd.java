...
@Data
public class UpdateConfirmInquiryCmd extends InquiryCommand {
    /**
     * 指令修改之前主键（skId）
     */
    ...
    public String getOriginSkId() {
        return originSkId;
    }

    public void setOriginSkId(String originSkId) {
        this.originSkId = originSkId;
    }
