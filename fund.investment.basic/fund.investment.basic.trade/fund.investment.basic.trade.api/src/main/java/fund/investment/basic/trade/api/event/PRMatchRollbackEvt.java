...
@Setter
@NoArgsConstructor
public class PRMatchRollbackEvt extends OrderEvent {
    ...
    public PRMatchRollbackEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String instrSkId, String instrSkInstr, String skCombi) {
