...
@NoArgsConstructor
@AllArgsConstructor
public class OrderChangedModifiedEvt extends OrderEvent {
    ...
    public OrderChangedModifiedEvt(String id, String tradeType, String instructionId, String unitId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
