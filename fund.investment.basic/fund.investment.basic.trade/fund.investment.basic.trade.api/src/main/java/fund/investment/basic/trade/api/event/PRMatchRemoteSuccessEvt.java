...
@Setter
@NoArgsConstructor
public class PRMatchRemoteSuccessEvt extends OrderEvent {
    ...
    public PRMatchRemoteSuccessEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String instrSkId, String instrSkInstr, String skCombi) {
