...
@NoArgsConstructor
@AllArgsConstructor
public class ConfirmingFillSuccessCmd extends OrderCommand {
    ...
    public ConfirmingFillSuccessCmd(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
