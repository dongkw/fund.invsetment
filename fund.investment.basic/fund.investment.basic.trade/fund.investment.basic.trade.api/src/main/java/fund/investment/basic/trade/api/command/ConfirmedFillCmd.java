...
@Setter
@NoArgsConstructor
public class ConfirmedFillCmd extends OrderCommand {
    ...
    public ConfirmedFillCmd(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
