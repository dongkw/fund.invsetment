...
@Setter
@NoArgsConstructor
public class ConfirmRejectOrderCmd extends OrderCommand  {
    ...
    public ConfirmRejectOrderCmd(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
