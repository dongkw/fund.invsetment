...
@Setter
@NoArgsConstructor
public class FillConfirmingEvt extends OrderEvent {
    ...
    public FillConfirmingEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String skInstr) {
