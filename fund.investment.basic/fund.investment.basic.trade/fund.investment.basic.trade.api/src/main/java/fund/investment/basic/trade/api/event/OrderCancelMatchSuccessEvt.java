...
@Setter
@NoArgsConstructor
public class OrderCancelMatchSuccessEvt extends OrderEvent {
    ...
    public OrderCancelMatchSuccessEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String instrSkId, String instrSkInstr, String skCombi) {
