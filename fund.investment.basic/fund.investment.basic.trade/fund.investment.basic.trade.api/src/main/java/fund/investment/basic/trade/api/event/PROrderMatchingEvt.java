...
@Setter
@NoArgsConstructor
public class PROrderMatchingEvt extends OrderEvent {
    ...
    public PROrderMatchingEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String instrSkId, String instrSkInstr, String skCombi) {
