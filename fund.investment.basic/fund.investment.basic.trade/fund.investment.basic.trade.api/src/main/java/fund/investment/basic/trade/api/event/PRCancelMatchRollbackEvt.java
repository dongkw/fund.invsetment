...
@Setter
@NoArgsConstructor
public class PRCancelMatchRollbackEvt extends OrderEvent {
    ...
    public PRCancelMatchRollbackEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String instrSkId, String instrSkInstr, String skCombi) {
