...
@Setter
@NoArgsConstructor
public class OrderChangeConfirmingEvt extends OrderEvent{
    ...
    public OrderChangeConfirmingEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String skInstr) {
