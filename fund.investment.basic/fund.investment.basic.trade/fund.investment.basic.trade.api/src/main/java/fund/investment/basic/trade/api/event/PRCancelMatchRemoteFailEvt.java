...
@Setter
@NoArgsConstructor
public class PRCancelMatchRemoteFailEvt extends OrderEvent {
    ...
    public PRCancelMatchRemoteFailEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String instrSkId, String instrSkInstr, String skCombi) {
