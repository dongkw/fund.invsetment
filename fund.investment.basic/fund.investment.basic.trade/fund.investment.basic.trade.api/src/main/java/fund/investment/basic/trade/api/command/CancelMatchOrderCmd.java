...
@Setter
@NoArgsConstructor
public class CancelMatchOrderCmd extends OrderCommand {
    ...
    public CancelMatchOrderCmd(String id, String instructionId, String tradeType, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
