...
@NoArgsConstructor
@AllArgsConstructor
public class BackPlacedOrderCmd extends OrderCommand {
    ...
    public BackPlacedOrderCmd(String id, String instructionId, String tradeType, String unitId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
