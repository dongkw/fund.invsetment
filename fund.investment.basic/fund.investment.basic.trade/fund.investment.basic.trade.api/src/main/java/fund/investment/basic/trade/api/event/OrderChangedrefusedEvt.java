...
@NoArgsConstructor
@AllArgsConstructor
public class OrderChangedrefusedEvt extends OrderEvent {
    ...
    public OrderChangedrefusedEvt(String id, String tradeType, String instructionId, String unitId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
