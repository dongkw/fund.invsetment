...
@Setter
@NoArgsConstructor
public class PROrderCancelMatchRollbackCmd extends OrderCommand {
    ...
    public PROrderCancelMatchRollbackCmd(String id, String instructionId, String tradeType, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
