...
@Setter
@NoArgsConstructor
public class OrderRejectedEvt extends OrderEvent {
    ...
    public OrderRejectedEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
