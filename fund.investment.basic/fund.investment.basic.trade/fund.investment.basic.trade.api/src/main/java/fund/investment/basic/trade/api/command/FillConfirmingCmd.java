...
@NoArgsConstructor
@AllArgsConstructor
public class FillConfirmingCmd extends OrderCommand {
    ...
    public FillConfirmingCmd(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
