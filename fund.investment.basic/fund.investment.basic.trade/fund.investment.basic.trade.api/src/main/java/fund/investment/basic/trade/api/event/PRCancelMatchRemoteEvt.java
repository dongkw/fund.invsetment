...
@Setter
@NoArgsConstructor
public class PRCancelMatchRemoteEvt extends OrderEvent {
    ...
    public PRCancelMatchRemoteEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String instrSkId, String instrSkInstr, String skCombi) {
