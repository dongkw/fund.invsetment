...
@Setter
@NoArgsConstructor
public class PRMatchRemoteEvt extends OrderEvent {
    ...
    public PRMatchRemoteEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String instrSkId, String instrSkInstr, String skCombi) {
