...
@Setter
@NoArgsConstructor
public class PRCancelMatchRemoteSuccessEvt extends OrderEvent {
    ...
    public PRCancelMatchRemoteSuccessEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String instrSkId, String instrSkInstr, String skCombi) {
