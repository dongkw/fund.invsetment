...
@NoArgsConstructor
@AllArgsConstructor
public class ChangeRefusedOrderCmd extends OrderCommand {
    ...
    public ChangeRefusedOrderCmd(String id, String instructionId, String tradeType, String unitId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime) {
