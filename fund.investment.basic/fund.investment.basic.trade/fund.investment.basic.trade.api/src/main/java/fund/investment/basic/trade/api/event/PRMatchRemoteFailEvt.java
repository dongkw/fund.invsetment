...
@Setter
@NoArgsConstructor
public class PRMatchRemoteFailEvt extends OrderEvent {
    ...
    public PRMatchRemoteFailEvt(String id, String tradeType, String instructionId, String userId, String skId, String chLastModifiedId, Date tsLastModifiedTime, String instrSkId, String instrSkInstr, String skCombi) {
