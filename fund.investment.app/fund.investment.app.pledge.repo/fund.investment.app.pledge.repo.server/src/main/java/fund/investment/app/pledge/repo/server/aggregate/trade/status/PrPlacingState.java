...
import fund.investment.basic.trade.server.aggregate.status.PlacingState;
import org.axonframework.modelling.command.AggregateLifecycle;

/**
 * @Author dongkw
 * @Date 2021/3/8、10:05 上午
 **/
public class PrPlacingState<T extends PledgeTradeElement> extends PlacingState<T> {
    @Override
