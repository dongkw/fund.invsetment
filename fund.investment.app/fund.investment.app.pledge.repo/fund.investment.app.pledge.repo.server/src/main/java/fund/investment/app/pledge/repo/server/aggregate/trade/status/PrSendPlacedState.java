...
import fund.investment.basic.trade.server.aggregate.status.SendPlacedState;
 ...
 **/
public class PrSendPlacedState<T extends PledgeTradeElement> extends SendPlacedState<T> {
    @Override
