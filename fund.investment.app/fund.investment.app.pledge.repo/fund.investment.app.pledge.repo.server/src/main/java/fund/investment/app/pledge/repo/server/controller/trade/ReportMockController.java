...
import fund.investment.app.pledge.repo.server.service.trade.PRReportHandler;
...
public class ReportMockController {
    ...
    private final PRReportHandler reportHandler;

    @Autowired
    public ReportMockController(PRReportHandler reportHandler) {
